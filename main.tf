...
data "aws_vpc" "vpc_tools" {
  filter {
    ...
    values = [
      "${var.aws_tags["stage"] == "pr" ? var.pr_tools_vpc_name : var.np_tools_vpc_name }-${var.aws_tags["stage"]}-vpc",
    ]
  }
}
...
data "aws_subnet" "tools_app_eu_central_1a" {
  filter {
    ...
    values = [
      "${var.aws_tags["stage"] == "pr" ? var.pr_tools_vpc_name : var.np_tools_vpc_name}-${var.aws_tags["stage"]}-sn-app-euc1a",
    ]
  }
...
data "aws_subnet" "tools_app_eu_central_1b" {
  filter {
    ...
    values = [
      "${var.aws_tags["stage"] == "pr" ? var.pr_tools_vpc_name : var.np_tools_vpc_name}-${var.aws_tags["stage"]}-sn-app-euc1b",
    ]
  }
...
data "aws_subnet" "tools_web_eu_central_1a" {
  filter {
    ...
    values = [
      "${var.aws_tags["stage"] == "pr" ? var.pr_tools_vpc_name : var.np_tools_vpc_name}-${var.aws_tags["stage"]}-sn-web-euc1a",
    ]
  }
...
data "aws_subnet" "tools_web_eu_central_1b" {
  filter {
    ...
    values = [
      "${var.aws_tags["stage"] == "pr" ? var.pr_tools_vpc_name : var.np_tools_vpc_name}-${var.aws_tags["stage"]}-sn-web-euc1b",
    ]
  }
